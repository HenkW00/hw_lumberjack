...
local resourceName = "hw_lumberjack"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "hw_lumberjack" then
            resourceName = "hw_lumberjack (" .. GetCurrentResourceName() .. ")"
    ...
    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_lumberjack/releases/latest", CheckVersion, "GET")
            Wait(3500000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_lumberjack/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/HenkW00/hw_lumberjack"

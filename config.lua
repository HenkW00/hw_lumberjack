...
Config.Alerts = {
    ...
    shop_text = 'Lumberjack Shop',
    bring_axe = 'Remove axe',
    axe_removed = 'You have successfully removed an axe from your inventory.',
    no_axe = 'You do not have an axe to remove.',
...
RegisterNetEvent('hw_lumberjack:notify')
AddEventHandler('hw_lumberjack:notify', function(title, message, msgType)	
